...
namespace GDD
{
    public class Enemy_SPP : Soldier
    {
        ...
        //Init enemy
        public Enemy_SPP(GameObject soldierObj, float mapWidth, Grid grid)
        {
            //Save what we need to save
            soldierTrans = soldierObj.transform;

            soldierMeshRenderer = soldierObj.GetComponent<MeshRenderer>();

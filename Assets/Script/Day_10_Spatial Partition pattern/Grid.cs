...
namespace GDD
{
    public class Grid
    {
        ...
        {
            Vector2 vision = friendlySoldier.vision / 2;
            /*
            ...
            */
            ...
            float cellX = friendlySoldier.soldierTrans.position.x;
            float cellZ = friendlySoldier.soldierTrans.position.z;
            ...
            for (int i = 0; i < cells_pos.Length / 2;)
            {
                ...
                {
                    Soldier new_enemy = cells[cells_pos[i, 0], cells_pos[i, 1]];
                    if (new_enemy != null)
                    {
                        float new_distance = Vector3.Distance(friendlySoldier.soldierTrans.position, new_enemy.soldierTrans.position);
                        ...
                        if (new_distance < distance || distance == 0)
                        {
                            ...
                            distance = Vector3.Distance(friendlySoldier.soldierTrans.position, enemy.soldierTrans.position);
                        }
                    }
                    ...
                    if (enemy != null)
                    {
                        Debug.Log("Found Enemy At : " + " Cell X : " + cells_pos[i, 0] + " Cell Y : " + cells_pos[i, 1]);
                        i = cells_pos.Length;
                    }*/
                }
                else
